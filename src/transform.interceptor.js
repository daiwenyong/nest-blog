...
var TransformInterceptor = exports.TransformInterceptor = function () {
    ...
    var TransformInterceptor = _classThis = /** @class */ (function () {
        ...
        TransformInterceptor_1.prototype.intercept = function (context, next) {
            return next.handle().pipe((0, operators_1.map)(function (data) {
                return {
                    code: (data === null || data === void 0 ? void 0 : data.code) !== undefined ? data.code : 1,
                    message: (data === null || data === void 0 ? void 0 : data.message) ? data.message : '请求成功',
                    data: (data === null || data === void 0 ? void 0 : data.data) ? data.data : data
                };
            }));
        };
