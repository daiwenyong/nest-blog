...
var is_exists_rule_1 = require("src/common/rules/is-exists.rule");
var CreateCategoryDto = exports.CreateCategoryDto = function () {
    var _a;
    ...
    return _a = /** @class */ (function () {
        ...
        (function () {
            _title_decorators = [(0, class_validator_1.IsNotEmpty)({ message: 'title不能为空' }), (0, is_exists_rule_1.IsExistsRule)('category', { message: '分类已存在' })];
